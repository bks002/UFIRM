            ...
            if (resp.ok && resp.status == 200) {
                return resp.json().then(rData => {
                    switch (type) {
                        case 'C':
                            if (rData === 'Created !') {
                                appCommon.showtextalert("Task Saved Successfully!", "", "success");
                  ...
                  <div className='row mt-2'>
                    <div className='col-6'>
                      ...
                      >
                        ...
                        {
                          this.props.categoryData ? this.props.categoryData.map((e, key) => {
                            return <option key={key} value={e.Id}>{e.Name}
                            </option>
                          }) : null
                        }
                      </select>
