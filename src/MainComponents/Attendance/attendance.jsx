...
export default function AttendanceMaster() {
  ...
  const getStatusColor = (status) => {
    switch (status) {
      ...
      case "Holiday": return "#0d6efd"; // blue
      case "Leave": return "#fd7e14";   // orange
      default: return "red";
    }
  };
                              ...
                              {!isSunday && dayAttendance.length > 0 && (
                                dayStatus === "Holiday" ? (
                                  ...
                                  <div style={{ fontSize: '0.95rem' }}>
                                    ...
                                    <div className="text-warning">Leave: {leaveCount}</div>
