...
const CategoryMaster = (props) => {
    ...
    const emptycategorydata = { Id: 0, Name: '', Color: '#FFA500', propertyId: propertyId, IsApproved: false };
   ...
   const getCategoriesList = useCallback(async (propertyId) => {
    try {
        ...
        const updatedData = data.map((item, index) => ({
            Id: item.Id || item.id || index + 1,  // fallback to index if Id missing
            Name: item.Name || item.name || '',
            Color: item.Color || item.color || '#FFA500',
            Action: ''  // Needed if your DataGrid expects Action column to exist
        }));
            ...
            {pageMode === 'Home' && (
                <div className="row">
                    <div className="col-12 ">
                        <div className="card">
                            <div className="card-header d-flex pl-5 align-items-center">
                                <h4 className="mb-0 pl-5">Category Master</h4>
                        ...
                        <div className="card-body pt-2">
                            <div style={{ overflowX: 'auto' }}>
                              <div style={{ minWidth: '1000px', paddingLeft: '100px', paddingRight: '20px' }}>
                                <DataGrid
                                    Id="CategoryGrid"
                                    IsPagination={false}
                                        ...
                                        <div className="col-12 mt-3">
                                            ...
                                            <SketchPicker
                                                ...
                                                onChangeComplete={(color) =>
                                                    setCategoryData(prev => ({ ...prev, Color: color.hex }))
                                                }
                                            />
                                        </div>
                                    </div>
                                    ...
                                    <form>
                                        <div className="row">
                                            ...
                                            <div className="form-group col-sm-6">
                                                ...
                                                <input type="text" className="form-control" id="viewColor" value={categoryData.Color} readOnly style={{ background: categoryData.Color }} />
                                            </div>
                                        </div>
                                    </form>
                                </div>
