                ...
                if (resp.ok && resp.status == 200) {
                    return resp.json().then(rData => {
                        ...
                        if (rData === 0) {
                            ...
                            if (type != 'D')
                                appCommon.showtextalert("Assets Saved Successfully!", "", "success");
                            else
                                appCommon.showtextalert("Assets Deleted Successfully!", "", "success");
                            this.handleCancel();
                        }
                    });
                }
                                    ...
                                    <div className="row">
                                        <div className="col-sm-6">
                                            <div className="form-group">
                                                <label for="txtAssetsNameL">Assets Name</label>
                                                <InputBox Id="txtAssetsName"
                                                    Value={this.state.Name}
                                                    onChange={this.updatetextmodel.bind(this, "Name")}
                                                    PlaceHolder="Asstes Name"
